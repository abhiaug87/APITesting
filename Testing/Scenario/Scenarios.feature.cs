...
#line 7
 testRunner.Then(string.Format("I am able to see the category name with headers {0}, {1}, {2}, {3}, {4} and {5}", content, corr, reqid, token, encoding, conn), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 15
 testRunner.When(string.Format("I pass headers {0}, {1}, {2}, {3}, {4} and {5}", content, corr, reqid, token, encoding, conn), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 16
 testRunner.Then(string.Format("I am able to see the canrelist status with headers {0}, {1}, {2}, {3}, {4} and {5" +
                        "}", content, corr, reqid, token, encoding, conn), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 24
 testRunner.When(string.Format("I pass headers {0}, {1}, {2}, {3}, {4} and {5}", content, corr, reqid, token, encoding, conn), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 25
 testRunner.Then(string.Format("I am able to see the promotions name with headers {0}, {1}, {2}, {3}, {4} and {5}" +
                        "", content, corr, reqid, token, encoding, conn), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
